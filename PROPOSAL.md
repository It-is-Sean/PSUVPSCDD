...
- `PROJECT.md` — long-lived project memory and current status
- `docs/probe/proposal.md` — proposal digest copy under docs
- `docs/probe/nova3r_mapping.md` — mapping from proposal ideas to concrete NOVA3R components
