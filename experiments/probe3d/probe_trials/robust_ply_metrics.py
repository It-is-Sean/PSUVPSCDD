#!/usr/bin/env python3
"""Robust point-cloud diagnostics for probe trial artifacts.
...
Typical use:
  ...
  python experiments/probe3d/probe_trials/robust_ply_metrics.py \
...
or scan a directory containing *_pred.ply / *_target.ply pairs:
  ...
  python experiments/probe3d/probe_trials/robust_ply_metrics.py \
    --dir experiments/probe3d/result/probe_trials/<run_dir>
"""
