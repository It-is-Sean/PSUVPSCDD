...
Probe trial harness for the frozen VGGT -> adapter -> frozen NOVA decoder probe.
...
Logs and artifacts live under `experiments/probe3d/result/probe_trials/<trial_id>/`.
