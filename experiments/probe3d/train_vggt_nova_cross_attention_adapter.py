...
from probe.adapter import VGGTToNovaCrossAttentionAdapter
...
def parse_args():
    ...
    parser.add_argument("--output_dir", default="experiments/probe3d/result/vggt23_nova_cross_attention_l4_scrream_cached_lr2e-5_seed17")
