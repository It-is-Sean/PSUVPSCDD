...
from probe.adapter import VGGTToNovaAttentionAdapter
...
def parse_args():
    ...
    parser.add_argument("--output_dir", default="experiments/probe3d/result/vggt23_nova_attention_long_seed17")
...
def main():
    ...
    adapter = VGGTToNovaAttentionAdapter(
